      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <p className="text-muted-foreground text-base md:text-lg max-w-2xl mx-auto">
            Try our AI-powered tools to get instant insights and improve your
        ...
        <Tabs defaultValue="audit" className="max-w-4xl mx-auto">
          ...
          <TabsContent value="planner">
            ...
            <div className="bg-background rounded-2xl p-6 md:p-8 border border-border/50 shadow-lg">
              ...
              <p className="text-muted-foreground text-sm mb-6">
                Generate a custom AI marketing strategy.
              </p>
              ...
              {planResult && (
                ...
                >
                  ...
                  {Object.entries(planResult).map(([key, val]) => (
          ...
          <TabsContent value="content">
            ...
            <div className="bg-background rounded-2xl p-6 md:p-8 border border-border/50 shadow-lg">
              ...
              <p className="text-muted-foreground text-sm mb-6">
                Enter a topic to generate AI content ideas.
              </p>
